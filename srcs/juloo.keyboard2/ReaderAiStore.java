...
final class ReaderAiStore extends SQLiteOpenHelper
{
  ...
  static final class Entry
  {
    ...
    Entry(long id, String readerItemId, String articleTitle, Type type,
        ...
        String promptIdentity, long createdAt, long updatedAt)
    {
      this.id = id;
  ...
  @Override public void onCreate(SQLiteDatabase database)
  {
    database.execSQL("CREATE TABLE " + TABLE + " ("
      ...
      + "prompt_identity TEXT NOT NULL, created_at INTEGER NOT NULL,"
      ...
      boolean oldestFirst)
  {
    ...
    if (!normalized.isEmpty())
    {
      ...
      String search = "(article_title LIKE ? ESCAPE '\\' OR content_markdown LIKE ? ESCAPE '\\' OR chat_markdown LIKE ? ESCAPE '\\' OR source_host LIKE ? ESCAPE '\\')";
      selection = selection == null ? search : selection + " AND " + search;
  ...
  private static Entry read(Cursor cursor)
  {
    ...
    return new Entry(number(cursor, "id"), nullableText(cursor,
        ...
        text(cursor, "model_id"), text(cursor, "prompt_identity"),
