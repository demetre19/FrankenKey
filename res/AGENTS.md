...
- Keyboard Reader is explicit default-off. Empty readable editors show a centered icon strip ordered Voice, Settings, AI, Read Clipboard, Library (Voice swaps to the right edge for left-handed use; AI stays centered). Real input/candidates hide the shortcuts. Explicit playback replaces candidates with title, transport, and speed.
